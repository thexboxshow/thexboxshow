 ...
 */
class HootKit_Products_Carticon_Widget extends HootKit_WP_Widget {
	...
	function display_widget( $instance, $before_title = '', $title = '', $after_title = '' ) {
		...
		$widget_template = ( $widget_template ) ? $widget_template : hootkit()->dir . 'template/widget-products-carticon.php';
