...
function hootkit_topbanner_display(){
	/* include ( apply_filters( 'hootkit_top_banner_template', hootkit()->dir . 'template/top-banner.php' ) ); */
	...
	$topbanner_template = ( $topbanner_template ) ? $topbanner_template : hootkit()->dir . 'template/top-banner.php';
