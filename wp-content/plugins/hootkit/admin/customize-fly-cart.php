...
function hootkit_flycart_display(){
	/* include ( apply_filters( 'hootkit_fly_cart_template', hootkit()->dir . 'template/fly-cart.php' ) ); */
	...
	$flycart_template = ( $flycart_template ) ? $flycart_template : hootkit()->dir . 'template/fly-cart.php';
