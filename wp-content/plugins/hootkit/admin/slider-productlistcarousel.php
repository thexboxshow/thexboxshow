 ...
 */
class HootKit_Slider_Productlistcarousel_Widget extends HootKit_WP_Widget {
	...
	function display_widget( $instance, $before_title = '', $title = '', $after_title = '' ) {
		...
		if ( is_string( $slider_template ) && file_exists( $slider_template ) ) include ( hootkit()->dir . 'include/slider-productlistcarousel.php' );
	}
