		...
		<div class="ticker-msgs">
			...
			foreach ( $ticker_posts_query as $post ) :
				...
				<div class="ticker-msg <?php echo $imgclass; ?>">
					...
					if ( $style == 'style2' ) $contentstyle = 'style="max-width:210px;white-space:normal;"'; else $contentstyle = 'style="max-width:none;white-space:nowrap;"'; // @todo remove in future version (only added for transition of theme css to v.2.9.1) ?>
