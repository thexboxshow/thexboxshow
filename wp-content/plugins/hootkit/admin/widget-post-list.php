...
class HootKit_Posts_List_Widget extends HootKit_WP_Widget {
	...
	function display_widget( $instance, $before_title = '', $title = '', $after_title = '' ) {
		...
		$default = ( !in_array( 'list-widget', hootkit()->get_config( 'supports' ) ) ) ? hootkit()->dir . 'template/widget-post-list-deprecated.php' : hootkit()->dir . 'template/widget-post-list.php'; // HootKit <= 1.1.3 // @todo remove in future version
