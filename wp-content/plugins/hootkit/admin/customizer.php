 ...
 * Customizer Modules
 *
 * This file is loaded at 'after_setup_theme' hook with 10 priority in HootKit->loadplugin()
 *
 * @package           Hootkit
...
function hootkit_customize_preview_js() {
	$script_uri = hootkit()->asset_uri( 'admin/assets/customize-preview', 'js' );
	if ( $script_uri )
...
function hootkit_customizer_enqueue_scripts() {
	$script_uri = hootkit()->asset_uri( 'admin/assets/customize-controls', 'js' );
	if ( $script_uri )
