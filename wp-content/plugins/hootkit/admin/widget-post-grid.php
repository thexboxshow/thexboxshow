...
class HootKit_Post_Grid_Widget extends HootKit_WP_Widget {
	...
	function display_widget( $instance, $before_title = '', $title = '', $after_title = '' ) {
		...
		$default = ( !in_array( 'grid-widget', hootkit()->get_config( 'supports' ) ) ) ? hootkit()->dir . 'template/widget-post-grid-deprecated.php' : hootkit()->dir . 'template/widget-post-grid.php'; // HootKit <= 1.1.3 // @todo remove in future version
